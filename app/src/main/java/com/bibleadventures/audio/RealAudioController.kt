...
class RealAudioController(
    ...
    private val voiceLineResIds: Map<CharacterVoiceLine, Pair<Int, Int>> = mapOf(
        ...
        CharacterVoiceLine.GOOD_SAMARITAN_DANGEROUS_ROAD to (R.raw.good_samaritan_dangerous_road_voice_b to R.raw.good_samaritan_dangerous_road_voice_g),
        ...
        CharacterVoiceLine.DANIEL_KINGS_DECREE to (R.raw.daniel_kings_decree_voice_b to R.raw.daniel_kings_decree_voice_g),
        CharacterVoiceLine.DANIEL_PRAYS to (R.raw.daniel_prays_voice_b to R.raw.daniel_prays_voice_g),
        CharacterVoiceLine.DANIEL_THROWN_TO_LIONS to (R.raw.daniel_thrown_to_lions_voice_b to R.raw.daniel_thrown_to_lions_voice_g),
        CharacterVoiceLine.DANIEL_NEXT_MORNING to (R.raw.daniel_next_morning_voice_b to R.raw.daniel_next_morning_voice_g),
        CharacterVoiceLine.DANIEL_NEW_PROCLAMATION to (R.raw.daniel_new_proclamation_voice_b to R.raw.daniel_new_proclamation_voice_g),
        CharacterVoiceLine.DANIEL_CHOICE_THANKFUL to (R.raw.daniel_choice_thankful_voice_b to R.raw.daniel_choice_thankful_voice_g),
        CharacterVoiceLine.DANIEL_CHOICE_TRUSTING to (R.raw.daniel_choice_trusting_voice_b to R.raw.daniel_choice_trusting_voice_g),
        CharacterVoiceLine.DANIEL_CHOICE_UNAFRAID to (R.raw.daniel_choice_unafraid_voice_b to R.raw.daniel_choice_unafraid_voice_g),
