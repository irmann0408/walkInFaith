package com.bibleadventures.ui.screens.esthersecretplot.intro
...
@Composable
fun EstherSecretPlotIntroScreen(
...
@Composable
private fun EstherSecretPlotIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = EstherSecretPlotContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun EstherSecretPlotIntroPreview() {
    BibleAdventuresTheme {
        EstherSecretPlotIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
