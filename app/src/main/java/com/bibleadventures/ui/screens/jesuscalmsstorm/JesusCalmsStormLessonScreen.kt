...
@Composable
fun JesusCalmsStormLessonScreen(
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val narration = stringResource(R.string.jesus_calms_storm_lesson_text)
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(
                    text = stringResource(R.string.jesus_calms_storm_lesson_title),
            ...
            Text(
                text = stringResource(R.string.jesus_calms_storm_lesson_text),
...
@Composable
private fun JesusCalmsStormLessonPreview() {
    BibleAdventuresTheme {
        JesusCalmsStormLessonScreen(onContinue = {})
    }
}
