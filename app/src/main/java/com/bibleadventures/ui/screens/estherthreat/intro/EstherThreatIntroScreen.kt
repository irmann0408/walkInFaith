package com.bibleadventures.ui.screens.estherthreat.intro
...
@Composable
private fun EstherThreatIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = EstherThreatContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun EstherThreatIntroPreview() {
    BibleAdventuresTheme {
        EstherThreatIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
