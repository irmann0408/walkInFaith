package com.bibleadventures.ui.screens.daniel.intro
...
@Composable
private fun DanielIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = DanielContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun DanielIntroPreview() {
    BibleAdventuresTheme {
        DanielIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
