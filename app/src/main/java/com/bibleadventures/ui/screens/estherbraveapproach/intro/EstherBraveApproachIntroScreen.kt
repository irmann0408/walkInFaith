package com.bibleadventures.ui.screens.estherbraveapproach.intro
...
@Composable
fun EstherBraveApproachIntroScreen(
    ...
    EstherBraveApproachIntroContent(
        character = character,
...
@Composable
private fun EstherBraveApproachIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = EstherBraveApproachContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun EstherBraveApproachIntroPreview() {
    BibleAdventuresTheme {
        EstherBraveApproachIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
