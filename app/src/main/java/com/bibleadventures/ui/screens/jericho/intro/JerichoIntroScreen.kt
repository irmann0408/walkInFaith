package com.bibleadventures.ui.screens.jericho.intro
...
@Composable
private fun JerichoIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = JerichoContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun JerichoIntroPreview() {
    BibleAdventuresTheme {
        JerichoIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
