package com.bibleadventures.ui.screens.estherbanquetsrescue.intro
...
@Composable
fun EstherBanquetsRescueIntroScreen(
    ...
    EstherBanquetsRescueIntroContent(
        character = character,
...
@Composable
private fun EstherBanquetsRescueIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = EstherBanquetsRescueContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun EstherBanquetsRescueIntroPreview() {
    BibleAdventuresTheme {
        EstherBanquetsRescueIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
