package com.bibleadventures.ui.screens.estherbraveapproach.choice
...
@Composable
fun EstherBraveApproachChoiceScreen(
    ...
    EstherBraveApproachChoiceContent(
...
@Composable
private fun EstherBraveApproachChoiceContent(
    selectedChoiceId: String?,
    onChoiceSelected: (String) -> Unit,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val selected = EstherBraveApproachContent.choiceOptions.find { it.id == selectedChoiceId }
        ...
        Column(
            ...
            if (selected == null) {
                Column(
                    ...
                    EstherBraveApproachContent.choiceOptions.forEach { option ->
                        AdventureMenuButton(
...
@Composable
private fun EstherBraveApproachChoicePreview() {
    BibleAdventuresTheme {
        EstherBraveApproachChoiceContent(selectedChoiceId = null, onChoiceSelected = {}, onContinue = {})
    }
}
