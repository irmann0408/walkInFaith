package com.bibleadventures.ui.screens.esther.intro
...
@Composable
private fun EstherIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = EstherContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun EstherIntroPreview() {
    BibleAdventuresTheme {
        EstherIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
