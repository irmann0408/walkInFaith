package com.bibleadventures.ui.screens.feeding5000.intro
...
@Composable
private fun Feeding5000IntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = Feeding5000Content.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun Feeding5000IntroPreview() {
    BibleAdventuresTheme {
        Feeding5000IntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
