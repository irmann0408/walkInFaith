package com.bibleadventures.ui.screens.esthernewqueen.intro
...
@Composable
private fun EstherNewQueenIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = EstherNewQueenContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun EstherNewQueenIntroPreview() {
    BibleAdventuresTheme {
        EstherNewQueenIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
