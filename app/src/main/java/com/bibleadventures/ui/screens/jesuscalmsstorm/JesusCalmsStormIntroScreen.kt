...
@Composable
fun JesusCalmsStormIntroScreen(
...
@Composable
private fun JesusCalmsStormIntroContent(
    character: CharacterCustomization,
    onContinue: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val audioController = LocalAudioController.current
    val lines = JesusCalmsStormContent.introDialogueLines.map { stringResource(it) }
...
@Composable
private fun JesusCalmsStormIntroPreview() {
    BibleAdventuresTheme {
        JesusCalmsStormIntroContent(character = CharacterCustomization(), onContinue = {})
    }
}
