...
object ChapterCatalog {
    val all: List<Chapter> = listOf(
        ...
        Chapter(
            id = ChapterId.ESTHER,
            titleRes = R.string.chapter_esther_title,
            descriptionRes = R.string.chapter_esther_description,
            lessonRes = R.string.chapter_esther_lesson,
        ...
        Chapter(
            ...
            requiredChapter = ChapterId.ESTHER,
        ),
        Chapter(
